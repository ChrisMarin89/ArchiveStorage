...
@section('content')
<form action="/config/parsertemplates" method="POST">
@csrf
            ...
            <div class="card">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-sm-6">
                                <h6 class="mt-2">Create Parser Template</h6>
                            </div><!-- /.col -->
                        ...
                        <div class="chartjs-size-monitor">
                            ...
                            <div class="mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-5">
                                        <input type="text" class="form-control" name="description" value="" placeholder="Type your description.">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-2">
                                        <input type="text" class="form-control" name="value" value="" placeholder="Type your value.">
                                    </div>
                                </div>
                            </div>
                        </div>            
