            ...
            <div class="card">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col-sm-6">
                                <h6 class="mt-2">Create Permission</h6>
                            </div><!-- /.col -->
                        ...
                        <div class="chartjs-size-monitor">
                            <div class="mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-2">
                                        <input type="text" class="form-control" name="name" value="" placeholder="Type your permission.">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        <input type="text" class="form-control" name="description" value="" placeholder="Type a description.">
                                    </div>
                                </div>
                            </div>
                        </div>            
